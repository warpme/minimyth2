...
CONFIG_SHELL = $(SHELL)
PKG_CONFIG_PATH = 
PKG_CONFIG_LIBDIR = $(DESTDIR)$(libdir)/pkgconfig:$(DESTDIR)$(datadir)/pkgconfig:$(DESTDIR)$(qtlibdir)/pkgconfig
...
MASTER_SITES += http://$(mm_MINIMYTH_ONLINE_UPDATES_URL)/pkg/minimyth2-garchive/$(GARNAME)-$(GARVERSION)/
