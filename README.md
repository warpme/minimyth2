...
SoC             | Tested on        | WiFi Chip & Support                    | eMMC boot | Net boot  | CEC Support | LED display | Sleep/Resume                   | Remarks                       |
----------------|------------------|----------------------------------------|-----------|-----------|-------------|-------------|--------------------------------|-------------------------------|
Allwinner H6    | EachLink H6 Mini | works  (rtl8723bs@SDIO)                | works     | not tested| works       | works       | well supported                 | well supported                |
Allwinner H6    | TanixTX6         | works  (ap6330@SDIO)                   | works     | not tested| works       | works       | works                          | well supported                |
Allwinner H6    | TanixTX6-Mini    | works  (xr819@SDIO)                    | not tested| not tested| works       | n/a         | not works                      | well supported                |
Allwinner H6    | Beelink GS1      | not works (fn-link6222@PCI-e no PCI-e) | works     | not works | works       | n/a         | not works (firmware issue)     | some things are still missing |
Allwinner H6    | OrangePi-3 LTS   | not works (aw859a)                     | works     | works     | works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | X96-Q(DDR3)      | works  (xr819@SDIO)                    | works     | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | X96-Q(LPDDR3)    | works  (xr819@SDIO)                    | works     | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | X96-Q(LPDDR3v1.3)| works  (xr819@SDIO)                    | works     | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | X96-Q(DDR3Lv5.1) | works  (xr819@SDIO)                    | works     | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | TanixTX1         | not works (9082@SDIO)                  | works     | n/a       | works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H616  | TanixTX6s-axp313 | works  (ap6330@SDIO)                   | not tested| not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Allwinner H616  | TanixTX6s        | works  (xr819@SDIO)                    | works     | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Allwinner H616  | Pendoo-X12Pro    | works  (sp6330@SDIO)                   | works     | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Allwinner H616  | OrangePi-Zero2   | works  (aw859a@SDIO)                   | not tested| works     | works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H618  | OrangePi-Zero3   | works  (uwe5622a@SDIO)                 | not tested| works     | works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H618  | Vontar H618      | works  (ap6334@SDIO)                   | works     | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Allwinner H618  | OrangePi-Zero2w  | works  (uwe5622a@SDIO)                 | not tested| works     | works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H618  | Transpeed-8k618t | works  (hk2735@SDIO)                   | works     | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Rockchip 3328   | Beelink A1       | works  (rtl8821@USB)                   | not works | not tested| works       | works       | currently power off/on         | well supported                |
Rockchip 3399   | RockPI 4-b       | works  (ap6256@SDIO)                   | works     | works     | works       | n/a         | currently power off/on         | well supported                |
Rockchip 3399   | RockPI 4-se      | works  (ap6255@SDIO)                   | works     | works     | works       | n/a         | currently power off/on         | well supported                |
Rockchip 3399   | OrangePi-4 LTS   | works  (uwe5622@SDIO)                  | works     | works     | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3528   | Vontar-R3        | not works                              | not tested| not tested| not works   | not works   | not works                      | missing VOP3 so no HDMI       |
Rockchip 3566   | X96-X6           | works  (am7256@SDIO)                   | works     | not tested| works       | works       | not works                      | good prospects                |
Rockchip 3566   | Quartz64 Model B | works  (cm256sm@SDIO)                  | not tested| works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3566   | URVE Pi          | works  (rtl8821@SDIO)                  | works     | not tested| not works   | n/a         | not works                      | good prospects                |
Rockchip 3566   | OrangePi-3B      | works  (uwe5622@SDIO)                  | not tested| not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3w (wifi6)  | works  (aic8800@SDIO)                  | works     | n/a       | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3w (wifi5)  | works  (ap6212@SDIO)                   | works     | n/a       | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3e          | n/a                                    | n/a       | works     | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Rock3-C          | works  (ap6256@SDIO)                   | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3568   | Rock3-A          | works  (iwl7265@PCI-e)                 | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3568   | Rock3-B          | works  (iwl7265@PCI-e)                 | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s  | Rock5A           | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s  | Rock5C           | works  (aic8800@USB)                   | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3576   | NanoPi-M5        | works  (rtl8822cs@SDIO)                | not tested| not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3576   | NanoPi-R76S      | works  (rtl8822cs@SDIO)                | works     | not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3576   | Rock4D           | works  (aic8800@SDIO)                  | UFS,works | works     | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3588s  | NanoPi-M6        | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s  | NanoPi-R6S       | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s  | OrangePi 5       | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s  | OrangePi 5 Pro   | works  (ap6256@SDIO)                   | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588s2 | Khadas Edge2     | works  (ap6275p@PCI-e)                 | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | Rock5B           | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | Rock5T           | works  (rtl8852@PCI-e)                 | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | Orange5 Plus     | n.a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | NanoPC-T6        | n.a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | NanoPC-T6-LTS    | n.a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Rockchip 3588   | Rock5 ITX        | n/a                                    | works     | works     | works       | n/a         | not works                      | good prospects                |
Amlogic s905    | TanixTX3-Mini    | not works (sv6051@SDIO no driver aval) | not tested| wip       | works       | WiP         | not works (firmware issue)     | support stalled               |
Amlogic s912    | Beelink GT1      | works v.unreliably (qca9377@SDIO)      | not tested| wip       | works       | n/a         | not works (firmware issue)     | support stalled               |
Amlogic sm1     | X96-Air          | works  (rtl8189@SDIO)                  | not tested| wip       | works       | WiP         | not works (firmware issue)     | support stalled               |
Amlogic s905d3  | Khadas VIM3l     | works  (ap6398s@SDIO)                  | not tested| wip       | works       | WiP         | not works (firmware issue)     | support stalled               |
Amlogic g12a    | Radxa-Zero       | works  (ap6256@SDIO)                   | not tested| wip       | works       | n/a         | not works (firmware issue)     | support stalled               |
Amlogic s905w2  | TV98             | not works                              | not tested| wip       | not works   | works       | not works (firmware issue)     | support in-progress           |
Amlogic s905y4  | Khadas VIM1S     | works  (ap6256@SDIO)                   | not tested| wip       | not works   | LED diode,OK| not works (firmware issue)     | support in-progress           |
Broadcom 2837   | Rpi3-b           | works  (brcm43430@SDIO)                | n/a       | not tested| works       | n/a         | no plans                       | all basics works nicelly      |
Broadcom 2711   | Rpi4-b           | works  (brcm4345@SDIO)                 | n/a       | works     | works       | n/a         | no plans                       | all basics works nicelly      |
Broadcom 2712   | Rpi5-b           | works  (brcm4345@SDIO)                 | n/a       | works     | works       | n/a         | no plans                       | all basics works nicelly      |
Intel i5        | i5 NUC           | n/a                                    | n/a       | works     | n/a         | n/a         | works (s3ram)                  | perfect support               |
Intel Z8500     | Beelink MII-V    | works  (ac3165@PCI-e)                  | not tested| works     | n/a         | n/a         | works (s1idle)                 | perfect support               |
Intel N3450     | Beelink BT4      | works  (ac3165@PCI-e)                  | not tested| works     | n/a         | n/a         | not works (bios issue)         | perfect support, bootsplah nok|
Intel N3450     | Beelink T34      | works  (ac3165@PCI-e)                  | not tested| works     | n/a         | n/a         | works (s3ram)                  | perfect support, bootsplah nok|
AMD E1-2100     | AMD Kabini       | n/a                                    | n/a       | works     | n/a         | n/a         | works (s3ram)                  | perfect support               |
Intel D2550     | ION2             | n/a                                    | n/a       | works     | n/a         | n/a         | works (s3ram)                  | perfect support               |
