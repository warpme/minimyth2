...
Allwinner H313  | X96-Q(DDR3)      | works  (xr819@SDIO)                    | works     | n/a       | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
Allwinner H313  | X96-Q(LPDDR3)    | works  (xr819@SDIO)                    | works     | n/a       | not tested| works       | LED Diode,OK| not works (firmware issue)     | some things are still missing |
...
Allwinner H616  | TanixTX6s        | works  (xr819@SDIO)                    | works     | n/a       | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
Allwinner H616  | Pendoo-X12Pro    | works  (sp6330@SDIO)                   | works     | n/a       | not tested| works       | works       | not works (firmware issue)     | some things are still missing |
...
Rockchip 3566   | OrangePi-3B      | works  (uwe5622@SDIO)                  | not tested| n/a       | not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3w (wifi6)  | works  (aic8800@SDIO)                  | works     | n/a       | n/a       | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3w (wifi5)  | works  (ap6212@SDIO)                   | works     | n/a       | n/a       | works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3566   | Zero-3e          | n/a                                    | n/a       | works     | works     | works       | LED Diode,OK| not works                      | good prospects                |
...
Rockchip 3576   | NanoPi-M5        | works  (rtl8822cs@SDIO)                | not tested| n/a       | not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3576   | NanoPi-R76S      | works  (rtl8822cs@SDIO)                | works     | n/a       | not tested| works       | LED Diode,OK| not works                      | good prospects                |
Rockchip 3576   | Rock4D           | works  (aic8800@SDIO)                  | UFS,works | works     | works     | works       | LED Diode,OK| not works                      | good prospects                |
...
Amlogic s905y4  | Khadas VIM1S     | works  (ap6256@SDIO)                   | works     | n/a       | works     | not works   | LED diode,OK| not works (firmware issue)     | support in-progress           |
