...
mm-all:
	...
	@if [ ! "$(mm_NVIDIA_VERSION)" = "387.34"    ] && \
	    [ ! "$(mm_NVIDIA_VERSION)" = "390.25"    ] && \
	    [ ! "$(mm_NVIDIA_VERSION)" = "387.34"    ] ; then \
