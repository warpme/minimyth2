...
PYTHON3_SET_BUILD_SYSCONF= \
	...
	-cp -v $(build_DESTDIR)$(build_libdir)/python$(PYTHON_VERSION_MAJOR).$(PYTHON_VERSION_MINOR)/_sysconfigdata__linux_i386-linux-gnu.py.build \
...
PYTHON3_SET_MAIN_SYSCONF= \
	...
	-cp -v $(build_DESTDIR)$(build_libdir)/python$(PYTHON_VERSION_MAJOR).$(PYTHON_VERSION_MINOR)/_sysconfigdata__linux_i386-linux-gnu.py.main \
	       $(build_DESTDIR)$(build_libdir)/python$(PYTHON_VERSION_MAJOR).$(PYTHON_VERSION_MINOR)/_sysconfigdata__linux_i386-linux-gnu.py; \
