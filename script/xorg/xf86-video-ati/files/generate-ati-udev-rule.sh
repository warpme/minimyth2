...
out_file='./05-minimyth-detect-x-ati-1.6.1.rules.disabled'
suported_devices_file='supported-ati-gfx-hardware.txt'
vendor_id='1002'
...
echo "#-------------------------------------------------------------------------------" >> ${out_file}
echo "" >> ${out_file}
echo "ENV{mm_detect_id}!=\"pci:0300:00:${vendor_id}:????:????:????\", GOTO=\"end-ati\"" >> ${out_file}
echo "" >> ${out_file}
